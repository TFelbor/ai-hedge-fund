# AI Hedge Fund *(adjusted for free API sourcing)*
...
4. Set your API keys (already done .env file so if you want to use code from this repository you'll have to change it in .env file for the ones you genereate):
```bash
